...
class HashTag(models.Model):
    ...
    hashtag = models.CharField(max_length=50, validators=[hashtag_validator])
...
class InstagramObject(models.Model):
    ...
    hashtag = models.ForeignKey(HashTag, on_delete=models.CASCADE, blank=True)
...
def get_user_image_folder(instance, filename):
    return f'{instance.user.username}/photos/'


def get_user_video_folder(instance, filename):
    return f'{instance.user.username}/videos/'
